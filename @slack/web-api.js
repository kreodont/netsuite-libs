define(['querystring', 'path', 'zlib', 'util', 'http', 'https', 'url', 'stream', 'assert', 'tty', 'os', 'fs'], (function (require$$0$2, require$$1$3, require$$8, require$$1$1, require$$3, require$$4$1, require$$5, require$$1$2, require$$4, require$$1, require$$0$1, require$$6) { 'use strict';
	...
	var isStreamExports = isStream$2.exports;
	...
	const EventEmitter = eventemitter3Exports$1;
	...
	*/
	...
	function requireFormData () {
		if (hasRequiredFormData) return FormData$2;
	...
	*/
	...
	function requireWebClient () {
		...
		(function (exports) {
			...
			const helpers_1 = __importDefault(helpers);
	...
	var index = /*@__PURE__*/getDefaultExportFromCjs(dist$3);
